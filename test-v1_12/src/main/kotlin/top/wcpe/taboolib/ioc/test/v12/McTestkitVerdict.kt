...
object McTestkitVerdict {
    ...
    /** 无编排时的 stdout 通过标记。 */
    private const val PASS_MARKER = "[TabooLibIocTestV12] PASS"

    /** 无编排时的 stdout 失败前缀。 */
    private const val FAIL_PREFIX = "[TabooLibIocTestV12] FAIL: "
    ...
    /**
     * 关服（尽力而为）：复用 Bukkit 反射，避免 main 源集对 spigot-api 的编译期耦合。
     *
